...
export const Header = () => {
  ...
  useEffect(() => {
    ...
    } else if (sessionStorage.getItem('role') === 'employees') {
      setDashboard('/employees');
    } else if (sessionStorage.getItem('role') === 'customers') {
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <Link
                  to="/"
                  className={`${dashboard == null || sessionStorage.getItem('role') == 'customers' ? 'block' : 'hidden'} py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700`}
                ...
                <Link
                  to={dashboard}
                  className={`${user != null && sessionStorage.getItem('role') != 'customers' ? 'block' : 'hidden'} py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700`}
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Dashboard
                </Link>
